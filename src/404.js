...
import icon from "./images/ricerooms/road.svg";
...
function FourZeroFour() {
    useEffect(() => {
        document.title = "Page not found | Ricerooms"
    }, []);
        ...
        <Container maxWidth="lg" component="main" style={{ paddingTop: theme.spacing(8), paddingBottom: theme.spacing(8) }}>
            <Grid container>
                <Grid item xs={12} sm={7} md={6}>
                    <div>
                        <Typography variant="h1" component="h3" style={{ paddingBottom: '.5rem', fontWeight: 'bold' }}>404 Error</Typography>
                        <Typography variant="h2" component="p" style={{ paddingBottom: '1.5rem' }}>
                            It looks like this Cul-de-sac is deserted</Typography>
